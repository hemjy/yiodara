...
namespace Yiodara.Infrastructure.Migrations
{
    ...
    [Migration("20250720210859_addedOtherSupportProvidedToPartnersTable")]
    partial class addedOtherSupportProvidedToPartnersTable
    {
            ...
            modelBuilder.Entity("Yiodara.Domain.Entities.Event", b =>
                {
                    ...
                    b.Property<List<string>>("OtherImageUrls")
                        .IsRequired()
                        .HasColumnType("text[]");
